...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val logTeacher=view.findViewById<Button>(R.id.Teacher)
        val logStudent=view.findViewById<Button>(R.id.Student)
        logTeacher.setOnClickListener{
            val accountsIntent = Intent(activity, LoginActivity::class.java)
            startActivity(accountsIntent)
        }
        logStudent.setOnClickListener{
            val accountsIntent = Intent(activity, LoginActivity::class.java)
            startActivity(accountsIntent)
        }
